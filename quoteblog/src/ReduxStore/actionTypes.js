...
export const ACCEPT_REQUEST = "SEND_REQUEST";
export const ACCEPT_REQUEST_SUCCESS = "SEND_REQUEST_SUCCESS";
export const ACCEPT_REQUEST_ERROR = "SEND_REQUEST_ERROR";

export const DELETE_REQUEST = "SEND_REQUEST";
export const DELETE_REQUEST_SUCCESS = "SEND_REQUEST_SUCCESS";
export const DELETE_REQUEST_ERROR = "SEND_REQUEST_ERROR";

export const USER_ROOMS = "USER_ROOMS";
export const USER_ROOMS_SUCCESS = "USER_ROOMS_SUCCESS";
export const USER_ROOMS_ERROR = "USER_ROOMS_ERROR";
