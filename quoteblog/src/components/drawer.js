...
function ResponsiveDrawer(props) {
  ...
  const drawer = (
    <div className="m-0 p-0" style={{background : "rgba(0,0,0,0.450)",color : "white", height : "100%"}}>
 
      
{

(loggedUser && loggedUser.profilePicture && loggedUser.profilePicture.imageURL)?
 <img src={loggedUser.profilePicture.imageURL} alt="dp" width = "100%" height="25%" style={{ filter:"grayscale(100%)" }} />
:
<img 
